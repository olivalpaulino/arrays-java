...
/*
Classe resposavel por criar uma tabela verdade utilizando os conceitos de array bidimensionais/multidimisionais
Criando uma matriz mxn, para representar e apresentar a tabela verdade da lógica booleana
Autor: Olival Paulino
*/
public class Arrays {

    public static void main(String[] args) {
        int[][] matriz = new int[4][7]; // declaracao da matriz
        
        // atribuindo valores nas posicoes correspondentes
        ...
        // preparando a apresentacao de dados no formato de tabela com prinf
        System.out.println("Tabela Verdade\n----------------------------------------------------------------------");
        System.out.printf("    %s    |    %s    |   %s    |  %s  |  %s  |  %s | %s |", "p", "q", "~p", "p ^ q", "p v q", "p -> q", "p <-> q");
        System.out.println("");
        
        // percorrendo a matriz e apresentando os valores de cada elemento
        for (int i=0; i<4; i++) {
            for (int j=0; j<7; j++) {
